    ...
    <div>
      <div className='grid md:grid-cols-2 md:gap-6 mb-6'>
        ...
        <div
          ...
          className='flex flex-col justify-center text-white bg-slate-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
        >
          <div>Add Invoice Item</div>
        </div>
      </div>
    </div>
  );
