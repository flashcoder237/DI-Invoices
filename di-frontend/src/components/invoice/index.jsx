...
const InvoiceList = () => {
  ...
  return (
    ...
    //       <li key={invoice.id}>
    //         <strong>Numéro de Facture:</strong> {invoice.invoiceNumber}<br />
    //         <strong>Client:</strong> {invoice.customer.name}<br />
    //         <strong>Total:</strong> {invoice.totalAmount}<br />
    //         {/* Ajoutez d'autres informations de la facture selon votre modèle */}
    //       </li>
    //     ))}
    //   </ul>
    // </div>
        <div className="relative overflow-x-auto sm:rounded-lg mt-20 mb-20">
        ...
        <div class="relative">
            ...
            class="block p-2 ps-5 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
